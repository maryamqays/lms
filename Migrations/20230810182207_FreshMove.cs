    ...
    public partial class FreshMove : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructorUsers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Overview = table.Column<string>(type: "nvarchar(2500)", maxLength: 2500, nullable: false),
                    ...
                    CourseLastUpdate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CourseIntroductionVideo = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    CourseFlyer = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CoursePdfFile = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Prerequisite = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    Level = table.Column<int>(type: "int", nullable: false),
                    Outcomes = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    ImportantDates = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    TargetAudience = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    Language = table.Column<int>(type: "int", nullable: false),
                    Fee = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsPreRecorded = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    InstructorUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Courses_InstructorUsers_InstructorUserId",
                        column: x => x.InstructorUserId,
                        principalTable: "InstructorUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DownloadTimes = table.Column<int>(type: "int", nullable: false),
                    CertifiedName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CourseHours = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_certificateUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_certificateUsers_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    DateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    InstructorPerformance = table.Column<int>(type: "int", nullable: false),
                    CourseContent = table.Column<int>(type: "int", nullable: false),
                    CourseDuration = table.Column<int>(type: "int", nullable: false),
                    CourseTime = table.Column<int>(type: "int", nullable: false),
                    OutComeAchievment = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DateOfOfEnrollment = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseCompleteId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Indx = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseChapterContent_CourseChapters_CourseChapterId",
            ...
            migrationBuilder.CreateTable(
                name: "CourseCompletes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CourseChapterContentId = table.Column<int>(type: "int", nullable: false),
                    IsCompleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseCompletes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseCompletes_CourseChapterContent_CourseChapterContentId",
                        column: x => x.CourseChapterContentId,
                        principalTable: "CourseChapterContent",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_certificateUsers_CourseId",
                table: "certificateUsers",
                column: "CourseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseCompletes_CourseChapterContentId",
                table: "CourseCompletes",
                column: "CourseChapterContentId",
                unique: true);
